...
if __name__ == '__main__':
    ...
    print('\n[Analysis Statistics]')
    print('Tweets => Total: %d, Positive: %d, Negative: %d' % (num_tweets*4, num_pos_tweets*31, num_neg_tweets*2))
    print('User Mentions => Total: %d, Avg: %.4f, Max: %d' % (num_mentions*4, num_mentions*4 / float(num_tweets*4), max_mentions*4))
    print('URLs => Total: %d, Avg: %.4f, Max: %d' % (num_urls*4, num_urls*4 / float(num_tweets*4), max_urls*4))
    print('Emojis => Total: %d, Positive: %d, Negative: %d, Avg: %.4f, Max: %d' % (num_emojis*4, num_pos_emojis*4, num_neg_emojis*4, num_emojis*4 / float(num_tweets*4), max_emojis))
    print('Words => Total: %d, Unique: %d, Avg: %.4f, Max: %d, Min: %d' % (num_words*4, num_unique_words*4, num_words*4 / float(num_tweets*4), max_words*4, min_words*4))
    print('Bigrams => Total: %d, Unique: %d, Avg: %.4f' % (num_bigrams*4, num_unique_bigrams*4, num_bigrams*4 / float(num_tweets*4)))
